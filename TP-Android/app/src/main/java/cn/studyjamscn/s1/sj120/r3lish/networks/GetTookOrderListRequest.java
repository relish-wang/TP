 ...
 */
public class GetTookOrderListRequest extends BaseJsonRequest<ArrayList<OrderEntity>> {

    Integer currentPage;
    Integer pageSize;

    public GetTookOrderListRequest(Integer currentPage, Integer pageSize) {
    ...
    protected String methodName() {
        return "index.php/Order/OrderListForReceived";
    }
