 ...
 */
public class GetPostedOrderListRequest extends BaseJsonRequest<ArrayList<OrderEntity>> {

    Integer currentPage;
    Integer pageSize;

    public GetPostedOrderListRequest(Integer currentPage, Integer pageSize) {
    ...
    protected String methodName() {
        return "index.php/Order/OrderListForSent";
    }
