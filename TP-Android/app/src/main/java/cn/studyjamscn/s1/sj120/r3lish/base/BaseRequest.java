...
import cn.studyjamscn.s1.sj120.r3lish.utils.NetworkThreadPoolExecutor;
...
public abstract class BaseRequest<T> {
     ...
     * 网络请求的域名
     */
//    public static final String BASE_URL = "http://192.168.1.113:7777/TP/TP/";//334阅览室
//    public static final String BASE_URL = "http://10.1.71.232:7777/TP/TP/";//232
    public static final String BASE_URL = "http://relish.wang/TP/";//阿里云虚机
     ...
     */
    protected abstract T parseResponse(@NonNull JSONObject response) throws JSONException;
